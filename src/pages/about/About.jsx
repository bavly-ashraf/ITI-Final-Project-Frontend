...
//           <h1 className="custom-font custom-font-black text-3xl lg:text-4xl font-bold leading-9 text-gray-800 pb-4">
//             About Us
//           </h1>
...
const About = () => {
  ...
  const { updateCart, getCart } = useContext(AuthContext);
  ...
  return (
    <div>
      ...
      <button onClick={() => handleAddToCart("product123")}>
        Add Product 1
      </button>
      <br></br>

      <button onClick={() => handleAddToCart("product456")}>
        Add Product 2
      </button>
      <br></br>

      <button onClick={() => handleAddToCart("product789")}>
        Add Product 3
      </button>
      <h2>Cart Data</h2>
      <ul>
        {cartData.map((product) => (
          <li key={product.id}>
            Product ID: {product.id}, Count: {product.count}
          </li>
        ))}
      </ul>
    </div>
