        ...
        <dialog id={`my_modal${edit? "_edit": ""}`} className="modal">
            <form method="dialog" className="modal-box">
                ...
                {/* <p className="py-4">Press ESC key or click the button below to close</p> */}
                    ...
                    <input name='description' onChange={handleAction} id='prod_description' type="text" placeholder="Product Description" defaultValue={edit? product?.details?.description : ""} className="input input-bordered input-warning w-full m-2" />
                    <label htmlFor='prod_height'>Height:</label>
                    <input name='height' onChange={handleAction} id='prod_height' type="text" placeholder="Height" defaultValue={edit? product?.details?.dimensions?.height : ""} className="input input-bordered input-warning w-2/12 max-w-xs m-2" />
                    <label htmlFor='prod_width'>Width:</label>
                    <input name='width' onChange={handleAction} id='prod_width' type="text" placeholder="Width" defaultValue={edit? product?.details?.dimensions?.width : ""} className="input input-bordered input-warning w-2/12 max-w-xs m-2" />
                    <label htmlFor='prod_depth'>Depth:</label>
                    <input name='depth' onChange={handleAction} id='prod_depth' type="text" placeholder="Depth" defaultValue={edit? product?.details?.dimensions?.depth : ""} className="input input-bordered input-warning w-2/12 max-w-xs m-2" />
                    <br />
