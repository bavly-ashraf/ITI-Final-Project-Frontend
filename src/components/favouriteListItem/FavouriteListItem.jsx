        ...
        <>
            ...
            <div className="container w-60">
                ...
                <h1 className='text-2xl'>{product.name}</h1>
                    ...
                    <svg onClick={()=>handleDelete(product._id)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="red" className="w-7 h-7 mt-3 m-auto cursor-pointer hover:stroke-2">
