    ...
    return ( 
        ...
        <div className='w-72 bg-white pb-2 rounded-xl hover:scale-105 ease-in-out duration-300'> 
            ...
            <div className='flex justify-evenly text-black'>
                {isAdmin?
                <>
                <svg xmlns="http://www.w3.org/2000/svg" onClick={()=>window.my_modal_1.showModal()} fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="blue" className="w-8 h-8 cursor-pointer hover:stroke-2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                </svg>
                <AddEditModal edit={true} />
                <svg xmlns="http://www.w3.org/2000/svg" onClick={()=>window.my_modal_2.showModal()} fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="red" className="w-8 h-8 cursor-pointer hover:stroke-2">
