    ...
    return ( 
        ...
        <div className='w-72 bg-white pb-2 rounded-xl hover:scale-105 ease-in-out duration-300'> 
            ...
            <div className='flex justify-evenly text-black'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" onClick={()=>window.my_modal_3.showModal()} fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="red" className="w-8 h-8 cursor-pointer hover:stroke-2">
