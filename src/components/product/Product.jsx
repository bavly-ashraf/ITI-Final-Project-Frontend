...
const Product = () => {
    return ( 
        ...
        <div className='w-72 bg-white pb-2 rounded-xl hover:scale-105 ease-in-out duration-300'> 
            ...
            <p className='text-black px-2'>If a dog chews chair whose chair does he choose?</p>
            <p className='text-project-main-color text-xl font-bold text-center py-2'>240EGP</p>
            <div className='flex justify-evenly text-black'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 hover:text-project-main-color">
